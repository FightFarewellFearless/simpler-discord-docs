...
* [$getGlobalUserVar](funcs/getGlobalUserVar.md)
* [$getServerVar](funcs/getServerVar.md)
* [$getUserVar](funcs/getUserVar.md)
* [$getVar](funcs/getVar.md)
* [$globalUserLeaderboard](funcs/globalUserLeaderboard.md)
...
* [$send](funcs/send.md)
* [$serverLeaderboard](funcs/serverLeaderboard.md)
* [$setChannelVar](funcs/setChannelVar.md)
* [$setGlobalUserVar](funcs/setGlobalUserVar.md)
